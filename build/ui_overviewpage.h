...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setText(QString::fromUtf8("0 HJC"));
        ...
        labelUnconfirmed->setText(QString::fromUtf8("0 HJC"));
        ...
        labelImmature->setText(QString::fromUtf8("0 HJC"));
        ...
        label_wallet_bgcoin->setMargin(0);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "<html><head/><body><p>The displayed information may be out of date. Your wallet automatically synchronizes with the ogt network after a connection is established, but this process has not completed yet.</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "<html><head/><body><p>The displayed information may be out of date. Your wallet automatically synchronizes with the ogt network after a connection is established, but this process has not completed yet.</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
