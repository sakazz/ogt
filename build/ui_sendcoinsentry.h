...
public:
    ...
    void retranslateUi(QFrame *SendCoinsEntry)
    {
        ...
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "<html><head/><body><p>The address to send the payment to (e.g. HGwKkMk834AA4zFyTi9i9vgUmpJxyGfBgf)</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
