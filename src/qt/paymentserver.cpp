...
const QString BITCOIN_IPC_PREFIX("ogt:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click ogt: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start ogt: click-to-pay handler");
    else
...
{
    // clicking on ogt: URLs creates FileOpen events on the Mac:
