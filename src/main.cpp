...
// Copyright (c) 2013 The ogt developers
...
uint256 hashGenesisBlock("0x00000107a123a98b0548a4513485ccd4ffc5bf425c2528097691154aec4f4e14");
static const unsigned int timeGenesisBlock = 1505124836;
...
const string strMessageMagic = "ogt Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "2017. The ogt release. ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x3902e8f55ec8ddef8b60383a9307223cf01108376b25476aeda87763ed1dcb5c"));
...
unsigned char pchMessageStart[4] = { 0x3c, 0x6a, 0x3c, 0x5f };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ogtMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ogtMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("ogtMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("ogt-miner");
    ...
    try { loop {
        ...
        printf("Running ogtMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
